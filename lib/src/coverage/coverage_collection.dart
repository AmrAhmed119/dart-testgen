...
///
/// [isInternalCall] indicates whether this function is called internally
/// while validating coverage improvement, to avoid regenerating the coverage
/// import file.
///
...
Future<void> _generateCoverageImportFile(String packagePath) async {
  ...
  final importStatements = Directory(path.join(packagePath, 'lib'))
